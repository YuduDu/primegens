/*
 * this module contains the Sequence Specific Primer Design function.
 * 
 */
...
/* use the sspd algorithm on the queries */
short sspd_loop(void) {
	short q=0, b=0, db=0, uo=0, pp=0;
	short res=0, bloop=0, cloop=0, c=0;
	size_t t_size;
	char cmd[COMMAND];
	FILE *fp, *fout4;
	...
	for(q=0; q < q_count; q++) {
		...
		printf("%s=================================================",T_S());
		printf("=================================================\n");
		printf("%s %06d) primerdesign for %.50s\n",T_S(),q+1,query[q].id);
		printf("%s=================================================",T_S());
		printf("=================================================\n");
	...
	/*STEP 1) primer design using primer3 ]**************/
		printf("%s\t\t_______________________________________________",T_S());
